	...
	<div class="container">
		<div class="masthead">
			...
			<ul class="nav nav-justified">
				...
				<li class="active"><a href="update.action">更改博客</a></li>
		...
		<div class="row">
			...
			<div class="col-md-9">
			<h3 class="text-muted page-header">修改博客</h3>
				<form action="update1.action" method="post" class="form-horizontal" id="updateBlogForm">
					<div class="form-group">
						<label for="blog_id" class="col-md-2 control-label">博客id</label>
						<div class="col-md-6">
							<input type="text" name="id" class="form-control"
								id="blog_id" placeholder="要更改的博客id">
						</div>
					...
					<div class="form-group">
						<div class="col-md-offset-2 col-md-10 ">
							<button type="submit" class="btn btn-default" id="submit1">提交修改</button>
						</div>
					</div>
				</form>
			</div>
