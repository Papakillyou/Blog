	...
	<div class="container">
		<div class="masthead">
			...
			<ul class="nav nav-justified">
				<li><a href="add.action">发布新闻</a></li>
				<li class="active"><a href="update.action">更改新闻</a></li>
		...
		<div class="row">
			...
			<h3 class="text-muted page-header">修改新闻</h3>
				<form action="update1.action" method="post" class="form-horizontal" id="updateNewsForm">
